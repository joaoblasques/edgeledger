...
|---|---|---|---|---|
| 1–2 | B1. What a model is | Why does a model beat a guess? | Features → probability mapping, generative vs discriminative, signal vs noise, bias-variance decomposition, why log-odds space is the natural space for binary event pricing | |
